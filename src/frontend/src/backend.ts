...
import type { AboutInfo as _AboutInfo, Project as _Project } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async initOwner(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.initOwner();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateAbout(arg0: string, arg1: Array<SocialLink>): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_AboutInfo]): AboutInfo | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Project]): Project | null {
    return value.length === 0 ? null : value[0];
}
